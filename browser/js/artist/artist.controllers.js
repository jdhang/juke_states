...
juke.controller('ArtistsCtrl', function ($scope, $log, artists, $rootScope, ArtistFactory) {
...
juke.controller('ArtistCtrl', function ($scope, $log, $stateParams, artist, ArtistFactory, PlayerFactory, $rootScope) {
